---
title: "BMEF: Bayesian  Mixed-Effects Models  for Multilevel Two-way Functional Data"
date: "`r format(Sys.Date())`"
author:  ""
output: github_document
---

This repository contains `R` code implementing Bayesian mixed-Effects models  for multilevel two-way functional data (BMEF) . The package can be installed as follows:
...
```{r simulate-and-fit, eval=TRUE, include=FALSE}
#library(BMEF)
devtools::load_all(".")
library(pracma)
library(splines)
...
```{r visualize, eval=TRUE,fig.width=9, fig.height=4.5}
library(tidyr)
library(ggplot2)
library(gridExtra)
...
```{r base-patterns, eval=TRUE,fig.width=12, fig.height=6}
